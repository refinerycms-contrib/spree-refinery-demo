...
Refinery::Resources.configure do |config|
  ...
  # config.dragonfly_secret = "e32a61650c141b407580d4333d571f9d6baef040f4296277"
  # config.dragonfly_url_format = "/system/resources/:job/:basename.:ext"
  # config.dragonfly_url_host = ""
  # config.datastore_root_path = "/Users/bricesanchez/Sites/refinery-test/spree-refinery/public/system/refinery/resources"
