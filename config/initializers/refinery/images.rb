...
Refinery::Images.configure do |config|
  ...
  config.dragonfly_secret = "25028408bd2857d732fd8ef6fd8de003a49158995cea6625"
  # config.dragonfly_url_format = "/system/images/:job/:basename.:ext"
  # config.dragonfly_url_host = ""
  # config.datastore_root_path = "/Users/bricesanchez/Sites/refinery-test/spree-refinery/public/system/refinery/images"
